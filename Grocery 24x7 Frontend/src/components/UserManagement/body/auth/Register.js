...
function Register() {
    ...
    const {name, email, address, phone, username, password, cf_password, err, success} = user
    ...
    const handleSubmit = async e => {
        e.preventDefault()
        if(isEmpty(name) || isEmpty(email) || isEmpty(address) || isEmpty(phone) || isEmpty(username) || isEmpty(password))
